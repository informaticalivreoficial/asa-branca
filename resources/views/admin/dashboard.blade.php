...
@section('content')
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="info-box">
                <span class="info-box-icon bg-info"><a href="" title="Vídeos"><i class="fa far fa-video"></i></a></span>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="info-box">
                <span class="info-box-icon bg-teal"><a href="" title="Eventos"><i class="fa far fa-newspaper"></i></a></span>
